...
public class Lock {
	...
	public void acquire() {
		...
		if (lockHolder != null) {
			//System.out.println("Error : Lock is holded by : "+lockHolder+"  acquire  Thread : "+KThread.currentThread().getName());
			waitQueue.waitForAccess(thread);
			KThread.sleep();
			//System.out.println("KThread "+KThread.currentThread().getName()+" get the Lock");
		} else {
			//System.out.println("Thread "+KThread.currentThread().getName()+" get the Lock");			
